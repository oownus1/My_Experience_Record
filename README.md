...
- 취업동아리 참가 (넥슨 선배님) 팔로우 경험, 팀원으로서 성실히 참여에 임하였습니다. 
- 수행하였던 것들 : 추후에 정리하여 기록 예정입니다. 

### 4학년 2학기 
- 취업(2022년7월 ~) 인턴회사로 좋게 봐주신 덕분에 취업을 하게 되었습니다. 
...
물리적/관리적 보호조치 점검 이행
  ...
  전 직원 대상 파이썬 데이터 분석 교육 진행
인프라 구축, 운영 테스트
AICC 구축/운영 경험 축적(Docker 활용)
...
- 품의 작성, 보고
- 유지보수 예산 문서화
- 인력 및 시스템/정보보호 운영 물리적/관리적 보 
  호조치 점검 이행

[개발 업무_업무 자동화]
- sweetviz 라이브러리 활용 고객사 수신 데이터 자동화(파이썬 활용)
- Paramiko 라이브러리 활용 정기점검 시스템 명령 자동화(파이썬 활용)
