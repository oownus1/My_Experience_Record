...
물리적/관리적 보호조치 점검 이행
  ...
  인삼공사 면접 경험 정리 -> 안성터미널에서 집합 저녁 8시 종료 (약 8시간 소요)
  PT 주제 : 자사 신규 시스템 도입 방안 -> 수치 분석 및 자사 현황 등의 자료 16개 지표를 준다 -> A, B, C 중 최선의 방안 선택하는 것 -> 이 주제가 토론까지로 이어짐 -> 큰 발표용
  만들 수 있는 거 하나, A4용지 -> A4 용지 한장은 토의와 발표시 지참 가능 -> 나는 수치를 우선 다 받아적음 
